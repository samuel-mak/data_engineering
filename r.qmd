...
# Create a second method for the summary generic for the case when the input to the object argument is an instance of the class "neural_network_model_fit"
setMethod(
  f = "summary",
  signature = signature(object = "nn"),
  definition = function(object, plot_model = F){
    print(object$call)
    if(plot_model){
    plot(object)}
...
science_neural_network_model_fit |> summary(plot_model = T)
